...
const AddBlog = () => {
    ...
    const onSubmit = data => {
        ...
        const url = `https://powerful-lowlands-88671.herokuapp.com/addBlog`
            ...
            <div className="row pt-3 mx-auto">
                <form onSubmit={handleSubmit(onSubmit)}>
                    <div className="col-10 form-group mx-auto">
                        <label className="mb-1"><b>Blog Title</b></label>
                    ...
                    <div className="col-10 text-center w-100 mt-3">
                        ...
                        <button className="w-50" type="submit" class="btn btn-success">Add Blog</button>
